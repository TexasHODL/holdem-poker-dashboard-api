...
optnlKeySets["table"] = {
  createTable: {
    chipsPointRatio: "Number",
    isPrivateTabel: "Boolean",
    passwordForPrivate: "String",
    favourite: "Boolean",
...
keySets["user"] = {
  ...
  transactionByOnlinePayment: {
    ...
    transactionMobile: "Number",
  },
};
internalFunctions["user"] = [];
handlerFunctions["user"] = [
  "forgotPasword",
  "resetPassword",
...
keySets["scratch"] = {
  createscratchcard: {
    scratchcardToName: "String",
    scratchcardAmount: "Number",
    scratchcardByRole: "String",
    scratchcardByName: "String",
    scratchcardByUserid: "String",
    amount: "Number",
    scratchcardToUserid: "String",
    scratchCardCode: "String",
  },
  redeemscratch: {
    redeemscratchCardCode: "String",
    userName: "String",
    userrole: "String",
...
keySets["scratchcards"] = {
  createScratchCardEmergency: {
    scratchCardType: "String",
    scratchCardDetails: "Array",
    totalAmount: "Number",
    isActive: "Boolean",
    expiresOn: "Number",
    playerId: "String",
...
keySets.validate = (type, serverType, methodName, clientKeys) => {
  if (!!!type || !!!serverType || !!!methodName || !!!clientKeys) {
    return {
      success: false,
      info: "Missing serverType | methodName | clientKeys",
    };
  }
  ...
  if (internalFunctions[serverType].indexOf(methodName) >= 0) {
    ...
    return {
      success: false,
      info:
        "No dictionary defined for function - " +
        methodName +
        " on " +
        serverType +
        " server!",
  ...
  for (var key in routeFromDict) {
    if (!clientKeys[key]) {
      // intentionally setting true for missing key for pushing key
